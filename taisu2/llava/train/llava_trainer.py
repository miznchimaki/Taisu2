...
class LLaVATrainer(Trainer):
    ...
    def get_train_dataloader(self) -> DataLoader:
        ...
        if not isinstance(train_dataset, torch.utils.data.IterableDataset) or isinstance(train_dataset, wds.DataPipeline):
            if not isinstance(train_dataset, wds.DataPipeline):
